...
/**
  ...
  */
light_handle_t ligh_create(ledc_timer_t timer, ledc_mode_t speed_mode, uint32_t freq_hz, uint8_t channel_num, ledc_timer_bit_t timer_bit);
...
/**
  ...
  *     - others: fail
  */
esp_err_t light_blink_starte(light_handle_t light_handle, uint32_t channel_mask, uint32_t period_ms);
